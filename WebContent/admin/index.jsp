              ...
              <li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li role="separator" class="divider"></li>
							<li><a class="text-center" href="#"> <strong>Ver todas las notificacion</strong> <i class="fa fa-angle-right"></i>
							</a></li>
						</ul></li>
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown" role="button" aria-haspopup="true"
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <ul class="nav nav-sidebar">
        	<li class="active"><a href=""><strong>Categorias</strong><span class="sr-only">(current)</span></a></li>
        </ul>
        <br>
          ...
          <% 
			...
			ArrayList <Categoria> lista = listcategoria.getCategoria();
 			...
 			%>
 			<li><a id="c<%=categoria.getCodigo()%>" href="admproductos.jsp?categoria=<%=categoria.getCodigo()%>"><%=categoria.getNombre()%></a></li>
          <% 
 			}
          %>
          </ul>
        ...
        <div id="div_admproductos" class="col-sm-9 admdiv">
<div class="container-fluid text-center">       
 <h2>Gestion de categorias</h2>
</div>
<br>
<div class="container-fluid text-right"> 
<input type="button" class="btn btn-default" value="Adicionar" id="adicionar" />
<input type="button" class="btn btn-default" value="Modificar" id="modificar" />
<input type="button" class="btn btn-success" value="Activar" id="activar" />
...
<div id="dialogo-mensaje" title="Gestion de Productos">
</div>
<div id="dialog-form" title="Forma Producto" class="form-group">
<p class="validateTips">Todos los campos son requeridos.</p>
<form>
<fieldset>
<input type="hidden" name="accion" id="accion" value="" />
<input type="hidden" name="codigo" id="codigo" value="" />
<label for="name">Nombre</label><input type="text" class="form-control" name="name"
id="name" value=""/>
